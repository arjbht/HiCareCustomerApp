...
import com.arj.hicarehygiene.databinding.FragmentAddAddressDemoBinding;
...
import com.arj.hicarehygiene.utils.FetchAddressIntentService;
 ...
 */
public class AddAddressDemoFragment extends BaseFragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, LocationManagerListner {
    FragmentAddAddressDemoBinding mAddAddressDemoBinding;
    ...
    public AddAddressDemoFragment() {
        // Required empty public constructor
    }

    public static AddAddressDemoFragment newInstance() {
        Bundle args = new Bundle();
        AddAddressDemoFragment fragment = new AddAddressDemoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAddAddressDemoBinding =
                DataBindingUtil.inflate(inflater, R.layout.fragment_add_address_demo, container, false);
        ...
        builder.build();
        return mAddAddressDemoBinding.getRoot();
        ...
        mMap.setOnCameraChangeListener(new GoogleMap.OnCameraChangeListener() {
            ...
            public void onCameraChange(CameraPosition cameraPosition) {
                ...
                try {
                    ...
                    setAddress(mCenterLatLong.latitude, mCenterLatLong.longitude);
                    mAddAddressDemoBinding.locationMarkertext.setText(setAddress(mCenterLatLong.latitude, mCenterLatLong.longitude));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    private void changeMap(Location location) {
        ...
        if (mMap != null) {
            ...
            mAddAddressDemoBinding.locationMarkertext.setText(setAddress(location.getLatitude(), location.getLongitude()));
//            mAddAddressDemoBinding.edtLocation.setText("Lat : " + location.getLatitude() + "," + "Long : " + location.getLongitude());
    ...
    protected void displayAddressOutput() {
        ...
        try {
            if (mAreaOutput != null)
                ...
                mAddAddressDemoBinding.edtLocation.setText(mAddressOutput);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private String setAddress(double lat, double long_temp) {
        ...
        try {
            ...
            try {
                ...
                mAddAddressDemoBinding.edtLocation.setText(addressstr);
