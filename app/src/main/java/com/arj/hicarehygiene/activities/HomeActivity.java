...
public class HomeActivity extends BaseActivity implements UserHomeClickHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mactivityHomeBinding.setHandler(this);
    ...
    private void selectFragment(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_orders:
                ...
                getSupportFragmentManager().beginTransaction().replace(mactivityHomeBinding.container1.getId(), OrderFragment.newInstance()).addToBackStack(null).commit();
...
//                startActivity(intent);
                getSupportFragmentManager().beginTransaction().replace(mactivityHomeBinding.container1.getId(), AccountFragment.newInstance()).addToBackStack(null).commit();
                break;
        }
    }
...
//                        addFragment(ProfileFragment.newInstance(), "dashboard-profileFragment");
                    ...
                    case R.id.nav_complaint:
                        getSupportFragmentManager().beginTransaction().replace(mactivityHomeBinding.container1.getId(), ComplaintHistoryFragment.newInstance()).addToBackStack(null).commit();
